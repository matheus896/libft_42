...
To properly anchor key knowledge and skills, it is essential to adopt a thoughtful approach to using AI tools and support.
...
- Yes, we know AI exists, and yes, it can solve your projects. But you are here to learn, not to prove that AI has learned. Do not waste your time, or ours, just to demonstrate that AI can solve the given problem.
- Learning at 42 is not about knowing the answer; it is about developing the ability to find one. AI gives you the answer directly, but that prevents you from building your own reasoning. And reasoning takes time, effort, and involves failure. The path to success is not supposed to be easy.
- Keep in mind that during exams, AI is not available: no internet, no smartphones, etc. You will quickly realise if you have relied too heavily on AI in your learning process.
- Peer learning exposes you to different ideas and approaches, improving your interpersonal skills and your ability to think divergently. That is far more valuable than just chatting with a bot. So do not be shy: talk, ask questions, and learn together!
- Yes, AI will be part of the curriculum, both as a learning tool and as a topic in itself. You will even have the chance to build your own AI software. In order to learn more about our crescendo approach you will go through the documentation available on the intranet.

```
✓ Good practice:
I am stuck on a new concept. I ask someone nearby how they approached it. We talk for 10 minutes, and suddenly it clicks. I get it.
```
```
✗ Bad practice:
I secretly use AI, copy some code that looks right. During peer evaluation, I cannot explain anything. I fail. During the exam, no AI, I am stuck again. I fail.
```
...
function 'f' to each node's content, and creates a
new list resulting of the successive applications of
